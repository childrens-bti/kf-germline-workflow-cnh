...
unfiltered indel and SV VCFs. For more information on the different ouptuts please refer to the [SvABA docs](https://github.com/walaj/svaba/tree/1.2.0#output-file-description).
